      ...
      <div className="hidden md:flex flex-col fixed top-0 left-0 items-center w-72 min-h-screen overflow-hidden text-gray-400 bg-gray-900 ">
        ...
        <div className="w-full px-2">
          <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
            ...
            <Link className="flex items-center w-full h-12 px-4 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="/admin/booking">
              <HeartHandshake />
              <span className="ml-5">Booking</span>
            </Link>
          </div>
        </div>
